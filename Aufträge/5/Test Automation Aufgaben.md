...
Tests für die **Spring Boot** wurden mit **Postman** umgesetzt. Es wurden 3 Tests erstellt:
...
Wir implementieren **Error Handling** für `POST /students` Route. Momentan werden die Felder nicht validiert und geben immer den Staus `200` zurück. Wir möchten die Anfragen in überprüfen und sicherstellen das `Name`und `Email` gegeben sind und korrekt sind:
